...
class Monte:
    def __init__(self, repeat_num = 200, select_depth = 1000, simulation_num = 1,expend_point = 5):
    ...
    def inherit(self,move):
        self.tree.inherit_tree(move)
